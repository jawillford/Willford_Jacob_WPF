...
var rateOfPeople = Number(prompt("How many more people are accessing your game per minute?"));

myFunction = function(limit, people, rateOfPeople){
    var spaceLeft = limit - people;
    var timeLeft = spaceLeft / rateOfPeople;
    alert("Your servers will be full in " + timeLeft + " minute.");
};
myFunction (limit, people, rateOfPeople);

if(people >= limit || rateOfPeople >= maxRate)alert("You should add a que to access your game in order to prevent your servers from crashing.");
